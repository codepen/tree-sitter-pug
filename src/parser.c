...
enum {
  ...
  sym__dedent = 23,
  sym__tag_name = 24,
  sym__script_tag_name = 25,
  sym__style_tag_name = 26,
  sym_raw_text = 27,
  sym_source_file = 28,
  sym_extends_statement = 29,
  ...
  aux_sym_path_repeat2 = 41,
  aux_sym__attributes_repeat1 = 42,
  aux_sym_tbd_repeat1 = 43,
};
...
enum {
  ...
  ts_external_token__tag_name = 3,
  ts_external_token__script_tag_name = 4,
  ts_external_token__style_tag_name = 5,
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [19] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_source_file_repeat1, 2), SHIFT_REPEAT(44),
  [22] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_source_file_repeat1, 2), SHIFT_REPEAT(51),
  ...
  [105] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_style_tag, 5),
  [107] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_style_tag, 5),
  [109] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_style_tag, 4),
  [111] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_style_tag, 4),
  [113] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_script_tag, 4),
  [115] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_script_tag, 4),
  [117] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_script_tag, 3),
  [119] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_script_tag, 3),
  [121] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_link_tag, 2),
  [123] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_link_tag, 2),
  [125] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_extends_statement, 3),
  [127] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_extends_statement, 3),
  ...
  [147] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_quoted_attribute_value, 3),
  [149] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_quoted_attribute_value, 3),
  ...
  [157] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_path_repeat1, 2), SHIFT_REPEAT(30),
  ...
  [170] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym__attributes_repeat1, 1),
  [172] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym__attributes_repeat1, 2),
  [174] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym__attributes_repeat1, 2), SHIFT_REPEAT(24),
